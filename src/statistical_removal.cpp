//StatisticalOutlierRemovalフィルター
//外れ値や異常値を切り取る
#include <ros/ros.h>
...
int main(int argc, char **argv)
{
    ...
    sor.setMeanK (50);//一つの点群が参照する点群数
    sor.setStddevMulThresh (1.0);//平均距離の標準偏差値
    ...
    pcl::io::savePCDFileBinary(ros::package::getPath("ros-pcl-tutorials") + "/data/result/statistical_" + file_name , *cloud_filtered);
