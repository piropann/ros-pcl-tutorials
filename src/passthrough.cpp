...
int main(int argc, char **argv)
{
    ...
    pass.setInputCloud (cloud);//処理する点群
    pass.setFilterFieldName ("y");//処理を行いたい座標
    pass.setFilterLimits(0, 1.0);//座標の間隔
    pass.filter(*cloud_filtered);//処理を行ったあとの格納場所
    ...
    pcl::io::savePCDFileBinary(ros::package::getPath("ros-pcl-tutorials") + "/data/result/passthrough_" + file_name , *cloud_filtered);
